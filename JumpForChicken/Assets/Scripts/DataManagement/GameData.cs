...
public class GameData{
    ...
    /// 가지고 있는 헬멧 (0번은 기본)
    /// </summary>
    public bool[] hasHelmets = {true, false, false, false};

    /// <summary>
    /// 가지고 있는 옷 (0번은 기본)
    /// </summary>
    public bool[] hasClothes = {true, false, false, false};

    /// <summary>
    /// 가지고 있는 오토바이 (0번은 기본)
    /// </summary>
    public bool[] hasMotorcycle = {true, false, false, false};
