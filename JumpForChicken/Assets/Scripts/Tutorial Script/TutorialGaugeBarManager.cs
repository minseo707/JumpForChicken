...
public class TutorialGaugeBarManager : MonoBehaviour
{
    // jumpHoldTime
    ...
    private TutorialCameraController tcc;
    ...
    void Start()
    {
        ...
        tcc = cameras.GetComponent<TutorialCameraController>();
    }
    ...
    void Update()
    {
        ...
        playerPos = new Vector3(player.transform.position.x + pam.lookAt * 0.7f, Mathf.Max(player.transform.position.y, tcc.cameraHeight - 7.5f), player.transform.position.z); // (x, y, z)
